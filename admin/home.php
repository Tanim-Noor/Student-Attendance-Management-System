	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/UITS-Short-01.png" width = "200px" height = "50px"/>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "well col-lg-12">
				<img src = "images/UITS-Short-02.png" width="1450px" height="500px" />
			<br />
			<br />	
			<br />	
			</div>
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				<label class = "pull-left">&copy; Attendance Record System 2023</label>
				<label class = "pull-right">@TanimNoor</a></label>
			</div>	
		</div>	
	</body>
